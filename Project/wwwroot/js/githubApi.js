...
function displayRepoInfo(data) {
    ...
    $("#repository-info").append(`<img class="sm:w-[216px] sm:h-[216px] w-[150px] h-[150px] 2xl:ml-[380px] xl:ml-[624px] ml-[276px] mt-[-90px]" src="${data["ownerAvatarURL"]}" id="github-repo-image" alt="Repo Image"/>`);
