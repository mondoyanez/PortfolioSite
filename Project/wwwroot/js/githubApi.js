...
function displayRepoInfo(data) {
    ...
    $("#repository-info").append(`<img class="w-[216px] h-[216px] 2xl:ml-[380px] xl:ml-[624px] ml-[210px] mt-[-90px]" src="${data["ownerAvatarURL"]}" id="github-repo-image" alt="Repo Image"/>`);
